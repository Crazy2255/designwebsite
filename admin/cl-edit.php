    ...
    if (empty($name)) {
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            ...
            if (!in_array(strtolower($filetype), $allowed)) {
                ...
                $target = 'uploads/clients/' . $new_image;
                ...
                if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
                    ...
                    if (!empty($client['image'])) {
                        $old_image = 'uploads/clients/' . $client['image'];
        ...
        if (!isset($_SESSION['error'])) {
            // Update client
            $stmt = $conn->prepare("UPDATE clients SET name = ?, image = ?, status = ? WHERE id = ?");
            ...
            <div class="container-fluid px-4">
                ...
                <nav aria-label="breadcrumb" class="mt-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="cl-index.php">Clients</a></li>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="cl-index.php" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="status" name="status" 
                                                   value="active" <?php echo $client['status'] == 'active' ? 'checked' : ''; ?>>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center my-3">
                                                <?php if (!empty($client['image']) && file_exists('uploads/clients/' . $client['image'])): ?>
                                                    <img id="imagePreview" src="uploads/clients/<?php echo $client['image']; ?>" 
                            ...
                            <div class="mt-4 border-top pt-3">
                                ...
                                <a href="cl-index.php" class="btn btn-secondary ms-2">
