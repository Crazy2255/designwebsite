...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        if (!isset($_SESSION['error'])) {
            // Insert color
            $stmt = $conn->prepare("INSERT INTO colors (name, category_id, color_code, image, status) VALUES (?, ?, ?, ?, ?)");
            $stmt->bind_param("sisss", $name, $category_id, $color_code, $image, $status);
            ...
            if ($stmt->execute()) {
                ...
                $_SESSION['error'] = "Failed to add color!";
            }
        }
    }
}
        ...
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="h3 mb-0">Add New Color</h1>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="input-group">
                                            <input type="color" class="form-control form-control-color" id="color_picker" 
                                                   value="<?php echo isset($_POST['color_code']) ? $_POST['color_code'] : '#000000'; ?>"
                                                   title="Choose your color">
                                            <input type="text" class="form-control" id="color_code" name="color_code" 
                                                   value="<?php echo isset($_POST['color_code']) ? $_POST['color_code'] : ''; ?>" 
