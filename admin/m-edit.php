...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        $image = $material['image']; // Keep existing image by default
        ...
        if (isset($_FILES['image']) && $_FILES['image']['error'] == 0) {
            ...
            if (!in_array(strtolower($filetype), $allowed)) {
                ...
                $target = 'uploads/materials/' . $new_image;
                ...
                if (move_uploaded_file($_FILES['image']['tmp_name'], $target)) {
                    ...
                    if (!empty($material['image'])) {
                        $old_image = 'uploads/materials/' . $material['image'];
        ...
        if (!isset($_SESSION['error'])) {
            // Update material
            $stmt = $conn->prepare("UPDATE materials SET name = ?, category_id = ?, image = ?, status = ? WHERE id = ?");
            ...
            <div class="container-fluid px-4">
                ...
                <nav aria-label="breadcrumb" class="mt-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="m-index.php">Materials</a></li>
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    ...
                    <a href="m-index.php" class="btn btn-secondary">
                    ...
                    <div class="card-body">
                        <form action="" method="POST" enctype="multipart/form-data">
                                        ...
                                        <select class="form-select" id="category_id" name="category_id" required>
                                            ...
                                            <?php foreach ($categories as $category): ?>
                                                <option value="<?php echo $category['id']; ?>" 
                                                    <?php echo $material['category_id'] == $category['id'] ? 'selected' : ''; ?>>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="status" name="status" 
                                                   value="active" <?php echo $material['status'] == 'active' ? 'checked' : ''; ?>>
                                        ...
                                        <div class="card-body">
                                            ...
                                            <div class="text-center my-3">
                                                <?php if (!empty($material['image']) && file_exists('uploads/materials/' . $material['image'])): ?>
                                                    <img id="imagePreview" src="uploads/materials/<?php echo $material['image']; ?>" 
                            ...
                            <div class="mt-4 border-top pt-3">
                                ...
                                <a href="m-index.php" class="btn btn-secondary ms-2">
