    ...
    if (empty($name)) {
        ...
        try {
            ...
            if ($stmt->execute()) {
                ...
                $error_message = "Error creating subcategory: " . $conn->error;
            }
        } catch (Exception $e) {
        ...
        <main class="p-4">
            <div class="container-fluid p-0">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <div>
                        <h1 class="h3 mb-2">Create Subcategory</h1>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" 
                                           ...
                                           <?php echo (!isset($status) || $status === 'active') ? 'checked' : ''; ?>>
                                    <label class="form-check-label" for="statusActive">Active</label>
                                </div>
                                <div class="form-check form-check-inline">
                                    <input class="form-check-input" type="radio" name="status" 
                                           id="statusInactive" value="inactive"
                                           <?php echo (isset($status) && $status === 'inactive') ? 'checked' : ''; ?>>
