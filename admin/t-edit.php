...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($person_name)) {
        ...
        // Update testimonial
        $stmt = $conn->prepare("UPDATE testimonials SET person_name = ?, designation = ?, message = ?, status = ? WHERE id = ?");
        $stmt->bind_param("ssssi", $person_name, $designation, $message, $status, $id);
    ...
    <div id="layoutSidenav_content">
        <main>
            <div class="container-fluid px-4">
                ...
                <div class="card">
                    <div class="card-body">
                        <form action="t-edit.php?id=<?php echo $id; ?>" method="POST">
                            <div class="row">
                                <div class="col-md-8">
                                    <div class="mb-3">
                                        ...
                                        <input type="text" class="form-control" id="person_name" name="person_name" 
                                               value="<?php echo htmlspecialchars($testimonial['person_name']); ?>" required>
                                    </div>
                                    
                                    <div class="mb-3">
                                        <label for="designation" class="form-label">Designation</label>
                                        <input type="text" class="form-control" id="designation" name="designation" 
                                               value="<?php echo htmlspecialchars($testimonial['designation']); ?>" required>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check form-switch">
                                            <input class="form-check-input" type="checkbox" id="status" name="status" 
                                                   value="active" <?php echo $testimonial['status'] == 'active' ? 'checked' : ''; ?>>
