...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($name)) {
        ...
        if (!isset($_SESSION['error'])) {
            // Insert wooden item
            $stmt = $conn->prepare("INSERT INTO wooden (name, category_id, image, status) VALUES (?, ?, ?, ?)");
            $stmt->bind_param("siss", $name, $category_id, $image, $status);
            
            if ($stmt->execute()) {
                $_SESSION['success'] = "Wooden item added successfully!";
                header("Location: w-index.php");
                exit();
            } else {
                $_SESSION['error'] = "Failed to add wooden item!";
            }
        }
    }
}
            ...
            <div class="container-fluid px-4">
                ...
                <nav aria-label="breadcrumb" class="mt-4">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Add New Wooden Item</li>
                    </ol>
                </nav>

                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h1 class="h3 mb-0">Add New Wooden Item</h1>
                        ...
                        <form action="" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="mt-4 border-top pt-3">
                                <button type="submit" class="btn btn-primary">
                                    <i class="fas fa-save me-2"></i>Save Wooden Item
                                </button>
